...
class BaseController extends CController {
	 ...
	 *
	 */
	protected function _getApiKeys($type=null,$key=null){
		$keys_arr =  require (ConfigDir . DS . 'apiKeys.php');
		if (!empty($type)) {
			if (!empty($key)) {
				return $keys_arr[$type][$key];
			}
			return $keys_arr[$type];
		}
     ...
     * @return void
     */
    public function performAjaxValidation($model,$form=null) {
        $form = $form ? $form : $this->id . '-form';

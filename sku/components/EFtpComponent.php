 ...
 * @from   http://www.yiiframework.com/extension/ftp
 */
class EFtpComponent extends CApplicationComponent
{
    ...
    public function connect()
    {
        if ($this->_connection === null) {
            ...
            if (!empty($this->username) AND !empty($this->password) && $this->_connection) {
     ...
     * @return bool|int Returns the last modified time as a Unix timestamp on success, or false on error.
     * @throws CDbException
     */

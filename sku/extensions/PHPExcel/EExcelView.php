...
/**
 * CGrivView 扩展，使用PHPExcel 导出 excel 文件
 * @example 
 ...
 * @license MIT License
 * @version 0.3
 * @see http://www.yiiframework.com/extension/eexcelview
 */
class EExcelView extends GridView {

    public $template = '{items}{summary}{pager}　　　{exportbuttons}';
    //Document properties
    public $creator = 'gatewang';
    public $title = null;
    ...
    public $libPath = 'comext.PHPExcel.PHPExcel'; //the path to the PHP excel lib
    //config
    ...
    public $grid_mode_var = 'grid_mode'; //GET var for the grid mode, export:下载，
    //buttons config
    public $exportButtonsCSS = 'summary';
    public $exportButtons = array('Excel5');
    public $exportText = '导出：';
    //callbacks
    ...
    public function renderBody() {
        ...
        /**
         * 这里有bug，数据量大的时候，无法导出，也没有报错,；findAll() 数据量大时候，不报错，无返回
         * 临时解决办法，设置  $this->disablePaging = false; 只能导出当前页码的数据
         */
    ...
    public function renderExportButtons() {
        //print_r($this->exportButtons);exit;

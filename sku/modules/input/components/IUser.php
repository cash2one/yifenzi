...
class IUser extends CWebUser
{
    ...
    public $_loginKey = 'inputLoginKey';
    public $_publicKey = 'inputPublicKey';
    ...
    public $loginPath = '/input/home/login/';
    public $homePath = '/input/home/index/';
...
//        var_dump($this);die;
     ...
     */
    public $setFlash=array('/site/login');
    /**

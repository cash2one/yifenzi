 ...
 * @since 1.1
 */
class InputColumn extends CGridColumn
{
...
//                $class = get_class($data);
        $value = $value ? $value : 0;
        $option = $this->htmlOptions;
        $option = array_merge($option, array('type' => $this->type, 'name' => $this->name . '[' . $data->primaryKey . ']', 'value' => $value, 'class' => $this->cssClass));
        $option['id'] = $this->id . '_' . $row;

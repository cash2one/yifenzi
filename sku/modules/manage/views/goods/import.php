    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tab-come">
        ...
        <tr>
            <td colspan="2">
                ...
                <?php echo CHtml::link('模板',Yii::app()->createUrl('goods/importTemplate'), array('class'=>'reg-sub')) ?>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <p style="color: red">上传文件只支持zip格式压缩包，压缩包里只能放图片和exel文件，不能放文件夹，图片只支持JPG、PNG格式，exel文件支持xlsx、xls格式，
                图片名称对应的是条形码。
                </p>
                <p style="color: red">一次只能上传一个商家的商品。</p>
            </td>
        </tr>
        </tbody>
    </table>

...
<div class="border-info clearfix">
      <table cellspacing="0" cellpadding="0" class="searchTable">
        <tbody><tr>
            <th align="right">
                <?php echo Yii::t('PartnerJoinAuditing','店铺名称'); ?>：
            </th>
            <td>
                <?php echo $form->textField($model,'store_name',array('size'=>11,'maxlength'=>11,'class'=>'text-input-bj  least')); ?>
            </td>
        </tr>
        </tbody>
      </table>
    ...
    <table cellspacing="0" cellpadding="0" class="searchTable">
        <tbody><tr>
            ...
            <td id="tdPay">
                <?php echo $form->radioButtonList($model,'status',  PartnerJoinAuditing::getStatus(),

...
$this->breadcrumbs = array(
    ...
    Yii::t('partnerModule.freshMachine', '修改生鲜机商品'),
);
?>

<div class="toolbar">
    <h3><?php echo Yii::t('partnerModule.freshMachine', '修改生鲜机商品'); ?></h3>
</div>
<?php
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
    <tbody>
        ...
        <tr>
            ...
            <td width="90%">  
                <?php echo $form->dropDownList($model, 'line_id', CHtml::listData($lines, 'id', 'name'), array('class' => 'inputtxt1', 'empty' => Yii::t('partnerModule.freshMachine', '请选择'))); ?>
...
jQuery(function($) {
    $('#seachRefMem').click(function() {
        dialog = art.dialog.open('" . $this->createAbsoluteUrl('goods/searchList') . "', { 'id': 'selectGoods', title:'".Yii::t('partnerModule.freshMachine','搜索商品')."', width: '1000px', height: '520px', lock: true });
    })
})

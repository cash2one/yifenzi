...
$this->breadcrumbs = array(
    ...
    Yii::t('partnerModule.freshMachine', '添加生鲜机货道'),
);
?>

<div class="toolbar">
    <h3><?php echo Yii::t('partnerModule.freshMachine', '添加生鲜机货道'); ?></h3>
</div>
<?php
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
    <tbody>
        ...
        <tr>
            ...
            <td >
                <?php $this->widget('comext.timepicker.timepicker', array('model' => $model, 'name' => 'expir_time', 'options' => array(), 'cssClass' => 'inputtxt1')); ?>（<?php echo Yii::t('partnerModule.freshMachine','不填则表示永不过期');?>）
        ...
        <tr>
            ...
            <td >  
                <?php echo $form->textField($model, 'gai_number', array('class' => 'inputtxt1', 'style' => 'width:300px;','value'=>$gai_number)); ?>（<?php echo Yii::t('partnerModule.freshMachine','默认自己的盖网号');?>）

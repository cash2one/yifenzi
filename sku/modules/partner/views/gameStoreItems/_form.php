...
<div class="mainContent">
    <div class="toolbar">
        <h3><?php echo $model->isNewRecord ? Yii::t('gameStoreItems', '添加商品') : Yii::t('gameStoreItems', '编辑商品') ?> </h3>
    </div>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
        ...
        <tr>
            <th><b class="red">*</b><?php echo Yii::t('gameStoreItems', '蜜蜂数量') ?></th>
            <td>
                <?php echo $form->textField($model, 'bees_number', array('class' => 'inputtxt1', 'style' => 'width:300px')); ?>(可设置0-9，0--抢到水果概率为100%，9为10%)

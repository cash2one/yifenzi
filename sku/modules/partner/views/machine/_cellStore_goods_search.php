    ...
    <div class="seachToolbar">
        <table width="95%" cellspacing="0" cellpadding="0" border="0" class="sellerT5">
            ...
            <tr>
                ...
                <td width="15%">
                    <?php echo CHtml::hiddenField('id',$mid)?>
                ...
                <td width="15%">
                    <?php echo $form->radioButtonList($model, 'status',array_merge(array(0=>Yii::t('partnerModule.superGoods','全部')) ,VendingMachineCellStore::getStatus()), array('separator' => '&nbsp')); ?>
                </td>

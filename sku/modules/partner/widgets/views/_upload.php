<script>
    //js 多语言显示
    var L = {
        imgManage:"<?php echo Yii::t('partner','图片管理') ?>",
        iframeNoLoad:"<?php echo Yii::t('partner','iframe还没有加载完毕') ?>",
        onlySelect:"<?php echo Yii::t('partner','只能选择') ?>",
        picNumber:"<?php echo Yii::t('partner','个图片!') ?>",
        "delete":"<?php echo Yii::t('partner','删除') ?>",
        ok:"<?php echo Yii::t('partner','确定') ?>",
        cancel:"<?php echo Yii::t('partner','取消') ?>"
    };
</script>
            ...
            <div class="imgbox">
                <div class="w_upload">
                    <a href="javascript:;"
                       ...
                       class="item_close"><?php echo Yii::t('partner','删除'); ?></a>
			<span class="item_box">

		...
		<form>
			...
			<?php if($goodsdata):?>
				...
				<li max="<?php echo $v['goods_number'];?>">
					...
					<a href="<?php echo Yii::app()->createUrl('/yifenzi/goods/view',array('id'=>$v['goods_id'],'nper'=>$v['current_nper']))?>"><img width=88 height=88 src="<?php echo $v['goods_thumb']?>"></a>
					<?php }else{?>
					<a href="<?php echo Yii::app()->createUrl('/yifenzi/goods/view',array('id'=>$v['goods_id'],'nper'=>$v['current_nper']))?>"><img width=88 height=88  src="<?php echo $v['goods_image']?>"></a>
					<?php }?>
		...
		$.ajax({
			...
			success:function(msg){
				...
				if ( msg.err == 2 || msg.err == '2' ){
					boolear = false;
// 					alert(msg.msg);
					window.location.href="/order/topayment/order_id/" + msg.msg;
				}		
			}
		});
	}

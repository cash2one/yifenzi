...
//                print_r($this->getPost('pay_type'));exit;
                ...
                switch( $this->getPost('pay_type') )
                {
                    ...
                    case 'pay_2':
                        ...
                        $noteUrl = array(
                            "return_url"    => DOMAIN_YIFENZI2.'/order/returnurl/',
                            "notify_url"    => DOMAIN_YIFENZI2.'/order/notifyurl/',
                        );
...
//            $input->SetNotify_url('http://www.g1fz.com/order/wxnotifyurl');
            $input->SetNotify_url(DOMAIN_YIFENZI.Yii::app()->createUrl('/yifenzi2/order/wxnotifyurl'));
...
//        print_r(Yii::app()->request->getHostInfo().Yii::app()->request->url);exit;
    ...
    public function today_amount(){
        ...
        $today_amount = !empty($accountBalance['today_amount'])?$accountBalance['today_amount']:0;
        return $today_amount;
    }

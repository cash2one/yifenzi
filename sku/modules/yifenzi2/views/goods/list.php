...
<script type="text/javascript" src="/yifenzi2/js/picLazyLoad.js"></script>
        ...
        function insertLi(){
            ...
            <?php
                  ...
                  foreach ($lists as $k => $an) {
                      $content .= '<li><a href="' . Yii::app()->createUrl('/yifenzi2/goods/view', array('id' => $an['goods_id'],'nper'=>$an['current_nper'])) . '"><img src="' . $an['goods_thumb'] . '"></a>' .
                          '<div class="right">' .
                          '<p class="name"><span>[第' . $an['current_nper'] . '期]</span>' . $an['goods_name'] . '</p>' .
                          '<a href="' . Yii::app()->createUrl('/yifenzi2/goods/view', array('id' => $an['goods_id'],'nper'=>$an['current_nper'])) . '"><p class="count">价值：￥' . $an['shop_price'] . '</p></a>' .
                          '<p class="card addTap" onclick="addGoods('.$an['goods_id'].')"></p>' .
                          '<a href="' . Yii::app()->createUrl('/yifenzi2/goods/view', array('id' => $an['goods_id'],'nper'=>$an['current_nper'])) . '"><div class="speedBox"><p class="speedbg"><span class="speed"><span class="speedIng" style="width:' . number_format($an['salesTotal'] / ($an['shop_price'] / $an['single_price']),2)*100 . '%"><i></i></span></span></p>' .
...
<div class="container">
    ...
    <ul class="list-group">
        <li onclick="javascript:window.location.href='<?php echo Yii::app()->createUrl("/yifenzi2/goods/announced")?>'">
            <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/announced')?>">
                <span class="active">最新揭晓</span>
                <i class="listIcon choose"></i>
            </a>
        </li>
        <li onclick="javascript:window.location.href='<?php echo Yii::app()->createUrl("/yifenzi2/goods/announced")?>?retUrl=<?php echo Yii::app()->request->url ?>&type=hot'">
            <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/announced')?>?retUrl=<?php echo Yii::app()->request->url ?>&type=hot">
                <span>人气</span>
            </a>
        </li>
        <li onclick="javascript:window.location.href='<?php echo Yii::app()->createUrl("/yifenzi2/goods/announced")?>?retUrl=<?php echo Yii::app()->request->url ?>&type=pricex'">
            <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/announced')?>?retUrl=<?php echo Yii::app()->request->url ?>&type=pricex">
                <span>价值（由高到低）</span>
            </a>
        </li>
        <li onclick="javascript:window.location.href='<?php echo Yii::app()->createUrl("/yifenzi2/goods/announced")?>?retUrl=<?php echo Yii::app()->request->url ?>&type=pricem'">
            <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/announced')?>?retUrl=<?php echo Yii::app()->request->url ?>&type=pricem">
                <span>价值（由低到高）</span>
            </a>
        </li>
        <li onclick="javascript:window.location.href='<?php echo Yii::app()->createUrl("/yifenzi2/goods/announced")?>?retUrl=<?php echo Yii::app()->request->url ?>&type=news'">
            <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/announced')?>?retUrl=<?php echo Yii::app()->request->url ?>&type=news">
                <span>最新</span>
            </a>
        </li>
    </ul>

<!--<script src="<?php echo Yii::app()->baseUrl ?>/yifenzi2/js/jquery.lazyload.min.js"></script>-->
<header>
    <h2>商品详情</h2>
    <a href="javascript:history.go(-1);" class="goback_btn"></a>
    <a href="<?php echo $this->createUrl('/yifenzi2/goods/periods', array('id' => $model->goods_id)) ?>" class="periods_show">第<?php echo $oldNper ? $oldNper : $model->current_nper ?>期<i></i></a>
</header>
<div class="container">
<div class="detail_wrap">
    <div class="detail_box">
        ...
        <div class="detail_img">
			...
			<img <?php if(empty($showImage1Exp[0]) && empty($showImage1Exp[1]) && empty($showImage1Exp[2])):?> onerror="this.src='/yifenzi2/images/img-load.png'" <?php endif ?> class="img_big"
            ...
            <a href="javascript:void(0)" ><img onerror="this.src='/yifenzi2/images/img-load.png'"  class="img_sm" src="<?php echo ATTR_DOMAIN . '/' . $showImage1Exp[0] ?>" data-src="<?php echo ATTR_DOMAIN . '/' . $showImage1Exp[0] ?>"></a>
			<?php endif ?>
            <?php if(!empty($showImage1Exp[1])):?>
            <a href="javascript:void(0)" ><img onerror="this.src='/yifenzi2/images/img-load.png'"  class="img_sm" src="<?php echo ATTR_DOMAIN . '/' . $showImage1Exp[1] ?>" data-src="<?php echo ATTR_DOMAIN . '/' . $showImage1Exp[1] ?>"></a>
            <?php endif ?>
            <?php if(!empty($showImage1Exp[2])):?>
            <a href="javascript:void(0)" ><img onerror="this.src='/yifenzi2/images/img-load.png'"  class="img_sm" src="<?php echo ATTR_DOMAIN . '/' . $showImage1Exp[2] ?>" data-src="<?php echo ATTR_DOMAIN . '/' . $showImage1Exp[2] ?>"></a>
            <?php endif ?>
        </div>
        ...
        <div class="detail_btn">
            ...
            ?>
            <a href="<?php echo $this->createUrl('/yifenzi2/goods/record', array('id' => $model->goods_id, 'nper' => $model->current_nper)); ?>">参与记录</a>
            <a href="<?php echo $this->createUrl('/yifenzi2/goods/viewDesc', array('id' => $model->goods_id)); ?>">图文详情</a>
        </div>
    </div>
</div>
</div>
...
<?php else: ?>
    <footer class="detail ongoing">
        <a class="blue" href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/view', array('id' => $model->goods_id,'nper'=> $nowNper)) ?>">第<?php echo $nowNper ?>期正在进行中...</a>
    </footer>
<?php endif; ?>

...
<ul class="list-group">
    <?php if ($this->action->id == 'announced'): ?>
        <li onclick="javascript:window.location.href='<?php echo Yii::app()->createUrl("/yifenzi2/goods/list")?>'">
            <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/list') ?>">
        ...
        <li onclick="javascript:window.location.href='<?php echo Yii::app()->createUrl("/yifenzi2/goods/announced", array("column_id" => $c["id"])) ?>'">
            <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/announced', array('column_id' => $c['id'])) ?>">
    ...
    <?php else: ?>
        ...
        <?php foreach ($column as $c): ?>
            <li onclick="javascript:window.location.href='<?php echo Yii::app()->createUrl("/yifenzi2/goods/list", array("column_id" => $c["id"])) ?>'">
                <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/list', array('column_id' => $c['id'])) ?>">
                    <!--<i class="listIcon Item<?php //echo $c['id'] ?>"></i>-->

<?php
Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl . '/yifenzi2/css/swiper.css');
?>
<script src="/yifenzi2/js/swiper.min.js"></script>
<script src="/yifenzi2/js/common.js"></script>
...
<header class="normal">
    <div class="head-wrap">
        ...
        <!--<a href="javascript:history.go(-1);" class="goback_btn"></a>-->
			...
			<a href="http://android/yifenzi2/returnGFT" class="goback_btn"></a>
			<?php endif?>
			<?php if (Yii::app()->session['type'] == 'ios'): ?>
			<a href="http://ios/yifenzi2/returnGFT" class="goback_btn"></a>
			<?php endif?>
...
<div class="warpbg">
        ...
        <div id="module_1" class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <?php foreach($advert as $k=>$v): ?>
                    <div class="two swiper-slide"><a href ="<?php echo $v['tourl']?>" ><img onerror="this.src='/yifenzi2/images/img-load.png'" data-original="<?php echo ATTR_DOMAIN . '/' . $v['img'] ?>" style="width: 100%;"/></a></div>
                <?php endforeach;?>
            </div>
            <!-- Add Pagination -->
    ...
    <?php } ?>
    <div class="popbox">
        <h4>人气推荐<a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/list');?>"></a></h4>
        <div id="module_2" class="swiper-container">
            <div class="swiper-wrapper">
                <?php foreach ($recommendcd as $r): ?>
                    <div class="one swiper-slide">
                        <div class="popItem">
                            <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/view',array('id'=>$r->goods_id,'nper'=>$r->current_nper))?>">
                                <?php
                                ...
                                ?>
                                <p class="memuImg"><img onerror="this.src='/yifenzi2/images/img-load.png'" width="100%" height="100%" data-original="<?php echo ATTR_DOMAIN . '/' . $r->goods_thumb ?>" /></p>
    ...
    <div class="newbox">
        <h4>最新揭晓<a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/announced')?>"></a></h4>
        <div class="newList">
            <ul>
                <?php foreach($announced as $an):?>
                <li>
                    <a class="imgbox" href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/view',array('id'=>$an['goods_id'],'nper'=>$an['current_nper']))?>"><img onerror="this.src='/yifenzi2/images/img-load.png'" data-original="<?php echo $an['thumb']?>"></a>
                    <div class="right">
                        <p class="name"><span>[第<?php echo $an['current_nper']?>期]</span><a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/view',array('id'=>$an['goods_id'],'nper'=>$an['current_nper']))?>"><?php echo $an['name']?></a></p>
    ...
    <div class="zonebox">
        ...
        <div class="zoneList">
            <ul>
                ...
                <li><a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/list');?>?column_id=<?php echo $v['id'] ?>"><img onerror="this.src='/yifenzi2/images/img-load.png'"  data-original="<?php echo ATTR_DOMAIN. '/' .$v['zone_thumb'] ?>"></a></li>
                <?php } ?>
...
<script src="/yifenzi2/js/picLazyLoad.js"></script>
<script>
//导航点击切换

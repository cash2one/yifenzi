            ...
            <ul>
                <li>
                    ...
                    <div class="right">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/view',array('id'=>$data['goods_id'],'nper'=>$data['current_nper']))?>"><?php echo $data['goods_name']?></a></p>
                        <p class="overTime max">
                            <span>获奖者：<i><?php echo $data['username']?></i></span>
                            <span>揭晓时间：<?php echo $data['sumlotterytime']?></span>
                        </p>
                        <p class="conduct"><a style="color:#fff;" href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/view',array('id'=>$data['goods_id'],'nper'=>$data['current_nper']))?>">第<?php echo $data['new_current_nper']?>期正在进行...</a></p>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="newList">
            <ul>
                <li>
                    ...
                    <div class="right">
                        <p class="name"><span>[第<?php echo $data['current_nper']?>期]</span>
                        	<a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/view',array('id'=>$data['goods_id'],'nper'=>$data['current_nper']))?>"><?php echo $data['goods_name']?></a>
                        </p>
                        <p class="count"></p>
        ...
        <div class="newList">
                <ul>
                    <li>
                        ...
                        <p class="conduct"><a href="<?php echo Yii::app()->createUrl('/yifenzi2/goods/view',array('id'=>$data['goods_id'],'nper'=>$data['current_nper']))?>" style="color: #fff">继续购买</a></p>
                    </div>
                </li>
            </ul>
        </div>

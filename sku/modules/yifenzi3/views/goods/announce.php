...
<script type="text/javascript">
            ...
            if (!refresh) {//第一次插入-----根据高度判断插入数
                ...
                if (<?php echo count($announce)?>){
                    ...
                    foreach ($announce as $an) {
                        ...
                        $content .= '<li nperid=' . $an['id'] . '><a class="imgbox" href="' . Yii::app()->createUrl('/yifenzi3/goods/view', array('id' => $an['goods_id'],'nper'=>$an['current_nper'])) . '"><img src="' . $an['thumb'] . '"></a><div class="right">' .
                            '<p class="name"><span>[第' . $an['current_nper'] . '期]</span><a href="' . Yii::app()->createUrl('/yifenzi3/goods/view', array('id' => $an['goods_id'],'nper'=>$an['current_nper'])) . '">' . $an['name'] . '</a></p>';
    ...
    $(function () {
        (function longPolling() {
            $.ajax({
                url: "<?php echo Yii::app()->createUrl('/yifenzi3/goods/send')?>",

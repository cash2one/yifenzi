...
<head>
    ...
    <script src="/yifenzi3/js/zepto.min.js" type="text/javascript"></script>
            ...
            if (<?php echo  !empty($record)?1:0;?>){
                ...
                foreach ($record as $r) {
                 ...
                 $addtime = date('Y-m-d H:i:s',$r['addtime']). substr($r['addtime'], strpos( $r['addtime'],'.'));
                    $content .= '<li><div class="guestInfo"><div class="guestIcon"><span><span style ="width: 50px;height: 50px;border-radius: 50%; vertical-align: middle; background-size: auto 100%;"><img src="/yifenzi3/images/userIcon.png" witdh="100%" height="100%"></span></span></div><div class="guestDetail"><p><strong>'.$GWnumber.'</strong><label><span>'.$price.'</span><span class="pIcon"></span><span class="mgl30"> '.$r['goods_number'].'</span><span class="fIcon"></span></label></p><p><small>'.$address.'</small><label><small class="black">'.$addtime.'</small></label></p></div></div></li>';
                }
                }
                ?>

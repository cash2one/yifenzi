...
<head>
    <meta charset="UTF-8">
    <title>一份子展示页</title>
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl?>/yifenzi3/css/common_m.css">
    <script src="<?php echo Yii::app()->baseUrl?>/yifenzi3/js/jquery-2.1.4.min.js" type="text/javascript" charset="utf-8"></script>
</head>
<script>
    (function () {

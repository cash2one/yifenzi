...
Vcity.allCity = ['北京|beijing|bj','上海|shanghai|sh', '重庆|chongqing|cq',  '深圳|shenzhen|sz', '广州|guangzhou|gz', '杭州|hangzhou|hz',
    ...
    '厦门|xiamen|xm', '西安|xian|xa','长沙|changsha|cs','合肥|hefei|hf','西藏|xizang|xz','香港|xianggang|xg','澳门|aomen|am', '内蒙古|neimenggu|nmg', '安庆|anqing|aq', '阿勒泰|aletai|alt', '安康|ankang|ak',

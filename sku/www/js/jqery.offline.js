...
$(document).ready(function (e) {
	$("#storeSlider ul li").each(function (i) {
		$("#storeSlider .thumb").append("<i></i>");
	});
	$('#storeSlider ul li').imgChange({ thumbObj:'#storeSlider .thumb i', curClass:'curr', effect:'scroll', speed:1000, changeTime:3000 ,easing: 'swing'})
	
	/*$("#offLineFocus ul li").each(function (i) {
        $("#offLineFocus .thumb .thumbList").append("<i></i>");
    });
    $('#offLineFocus ul li').imgChange({ thumbObj:'#offLineFocus .thumb .thumbList i',botPrev: '#offLineFocus .thumb .arrowPrev', botNext: "#offLineFocus .thumb .arrowNext", curClass:'curr', effect:'scroll',vertical: false, speed:1000, changeTime:3000 ,easing: 'swing' })
	*/

...
$(document).ready(function(e) {
	...
	$(window).resize(function(){
		...
		$('.proSlider .touchslider-viewport').css('height',512*(width/640));
		$('.proSlider .touchslider-item a').css('width',512*(width/640));
		...
		$('.brand li').css('height',92*(width/640));
		$('.brand li img').css('height',92*(width/640));
		...
		$('.mallClass li:first-child,.mallClass li.first').css('height',328*(width/640));
		...
		$('.shareTips .h185').css('height',185*(width/640));
		$('.shareTips .h190').css('height',190*(width/640));
		$('.shareTips .h270').css('height',270*(width/640));
		$('.shareTips .h245').css('height',245*(width/640));
		$('.gxui-tab').tab();
	}).resize();
	...
	/* $$menuShow.find(".icoMenu").toggle(
		 function(){				
			if($(this).is(":first-child"))
				{					
					$$menuShowbox.parent('.mainNav').find('.navMenu').hide();
					$$menuShowbox.parent('.mainNav').find('.navSearch').show();
				}
			else
				{					
					$$menuShowbox.parent('.mainNav').find('.navSearch').hide();
					$$menuShowbox.parent('.mainNav').find('.navMenu').show();
				}
				$(this).addClass('hover');				
				$(this).siblings('.icoMenu').removeClass('hover');

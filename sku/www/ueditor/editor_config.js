...
//        UEDITOR_HOME_URL : URL
        ...
        //图片上传配置区
//        ,imageUrl:URL+"?r=ueditor/imageUp"             //图片上传提交地址
//        ,imagePath:"http://att.gatewang.com/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        maxImageSideLength:9999                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中

        //涂鸦图片配置区
//        scrawlUrl:URL+"?r=ueditor/scrawlUp"           //涂鸦上传地址
//        ,scrawlPath:"http://att.gatewang.com/"                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"ueditor/php/fileUp.php"               //附件上传提交地址
        ,filePath:"http://skuapi.g-emall.com/"                   //附件修正地址，同imagePath
        ...
        //图片在线管理配置区
//        ,imageManagerUrl:URL + "?r=ueditor/imageManager"       //图片在线管理的处理地址
//        ,imageManagerPath:"http://att.gatewang.com/"                                     //图片修正地址，同imagePath
